...
<main id='main'>
    ...
    <section id='portfolio-details' class='portfolio-details'>
        <div class='container'>
            ...
            <h1 class='animate__animated animate__fadeInDown'>Scholarship 1</h1>
            <div class='row'>
                <div class='col'>
                    $1000
                </div>
            ...
            <div>
                <a href='http://www.scholarship1.com' class='btn-get-started animate__animated animate__fadeInUp scrollto'>APPLY NOW</a>
            </div>
            <hr class='mb-3'>
            <div>
            ...
            <div>
                <h4>Description</h4>
                <p>Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description Big description</p>
            </div>
